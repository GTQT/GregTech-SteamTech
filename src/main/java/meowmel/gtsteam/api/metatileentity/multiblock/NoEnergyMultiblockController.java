package meowmel.gtsteam.api.metatileentity.multiblock;
...
public abstract class NoEnergyMultiblockController extends MultiblockWithDisplayBase implements IDataInfoProvider, IDistinctBusController {
