package meowmel.gtsteam.common.metatileentities.single;
...
import meowmel.gtsteam.api.metatileentity.single.PseudoMultiMachineMetaTileEntity;
...
public class MetaTileEntityLatexCollector extends PseudoMultiMachineMetaTileEntity {
    ...
    public MetaTileEntityLatexCollector(ResourceLocation metaTileEntityId, int tier) {
        super(metaTileEntityId, GTSRecipeMaps.SAP_COLLECTOR_RECIPES, GTSteamTextures.SAP_COLLECTOR_OVERLAY, tier, true, GTUtility.largeTankSizeFunction);
        this.tankSize = 16000;
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        GTSteamTextures.SAP_COLLECTOR_OVERLAY.renderOrientedState(renderState, translation, pipeline, this.getFrontFacing(), this.isActive(), true);
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.set(1, I18n.format("gtsteam.machine.latex_collector.tooltip"));
    }
