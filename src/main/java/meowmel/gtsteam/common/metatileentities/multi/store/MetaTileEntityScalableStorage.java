...
import meowmel.gtsteam.common.item.storageupdate.ItemStorageUpgrade;
import meowmel.gtsteam.common.item.storageupdate.ItemVoidUpgrade;
...
public class MetaTileEntityScalableStorage extends MultiblockWithDisplayBase {
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @NotNull List<String> tooltip,
                               boolean advanced) {
        tooltip.add(I18n.format("gtsteam.machine.scalable_storage.tooltip1"));
        tooltip.add(I18n.format("gtsteam.machine.scalable_storage.tooltip2"));
        tooltip.add("");
