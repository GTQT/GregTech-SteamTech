 ...
 */
public class LargeCombustorRecipeLogic extends AbstractRecipeLogic implements ICategoryOverride {
    ...
    MetaTileEntityLargeCombustor metaTileEntity;
    // 上一tick产生的热量
     ...
     */
    public LargeCombustorRecipeLogic(MetaTileEntityLargeCombustor tileEntity) {
    ...
    protected void updateRecipeProgress() {
        if (canRecipeProgress) {
            ...
            if (getCurrentTemp() < getMaximumHeat()) {
                setTemp(Math.min(getCurrentTemp() + 4, getMaxTemp()));
            }
    ...
    @NotNull
    @Override
    public MetaTileEntityLargeCombustor getMetaTileEntity() {
        return (MetaTileEntityLargeCombustor) super.getMetaTileEntity();
    }
