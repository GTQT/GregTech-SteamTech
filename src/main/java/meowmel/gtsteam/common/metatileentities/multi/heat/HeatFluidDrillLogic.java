...
public class HeatFluidDrillLogic {

    public static final int MAX_PROGRESS = 20;
    private final MetaTileEntityHeatFluidDrill metaTileEntity;
    ...
    public HeatFluidDrillLogic(MetaTileEntityHeatFluidDrill metaTileEntity) {
    ...
    protected boolean consumeEnergy(boolean simulate) {
        if (simulate) return metaTileEntity.getHeatStored() > 32;
        if (metaTileEntity.getHeatStored() > 32) {
            metaTileEntity.changeHeat(-32);
            return true;
        }
        return false;
    }
    ...
    protected boolean checkCanDrain() {
        ...
        if (this.hasNotEnoughEnergy &&
                metaTileEntity.getHeatStored() > 32) {
    ...
    protected boolean isOverclocked() {
        return metaTileEntity.getTemperature() > 673;
    }
